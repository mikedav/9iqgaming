...
function love.load()
  ...
  objects.ground = {}
  objects.ground.body = love.physics.newBody(world, mapWidth*tileSize/2, love.graphics.getHeight()-25) --remember, the shape (the rectangle we create next) anchors to the body from its center, so we have to move it to (650/2, 650-50/2)
...
function updateTilesetBatch()
  ...
  for x=0, tilesDisplayWidth-1 do
    for y=0, tilesDisplayHeight-1 do
      	if(mapX>0 and mapY>0 and mapX<mapWidth and mapY<mapHeight) then
